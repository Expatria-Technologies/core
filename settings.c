...
PROGMEM static const setting_detail_t setting_detail[] = {
     ...
     { Setting_ToolChangeMode, Group_Toolchange, "Tool change mode", NULL, Format_RadioButtons, "Normal,Manual touch off,Manual touch off @ G59.3,Automatic touch off @ G59.3,Fully Automatic @G59.3,Ignore M6", NULL, NULL, Setting_IsExtendedFn, set_tool_change_mode, get_int, is_setting_available },
...
PROGMEM static const setting_descr_t setting_descr[] = {
    ...
    { Setting_ToolChangeMode, "Normal: allows jogging for manual touch off. Set new position manually.\\n\\n"
                              ...
                              "Fully automatic uses LinuxCNC style tool table and automatic measurement at G59.3.\\n\\n"
